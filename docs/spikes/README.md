...
| [S012](012-unmodified-java-companion-bridge.md) | Reproduce S011 through an injected bridge while keeping the official Java extension and proxy unmodified | Gate A contracts and deterministic bridge bundle verified synthetically; Gate B not started |
