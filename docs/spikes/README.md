...
| [S005](005-classpath-callback-routing.md) | Intercept and route one classpath callback in disposable proxy code | Gate A implementation and synthetic diff review complete; awaiting Gate B continuation |
