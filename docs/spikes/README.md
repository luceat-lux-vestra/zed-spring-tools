...
provider enumeration caused the ChatGPT warning. S009 is now planned and
reviewed as one controlled run; no S009 code or runtime exists yet.
...
| [S009](009-attributed-isolated-profile.md) | Compose source-controlled profile/XDG settings with one fixed managed-JDT start | Planned and reviewed; Gate A not started |
