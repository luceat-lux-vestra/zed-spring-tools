...
- Status: Route selection complete; every route below has been taken or settled,
  and M4 closed on 2026-07-26. Two of the three rows that awaited a direction
  decision were decided on 2026-07-29, leaving one — the embedded MCP server,
  pending an observation — beside the four naming a missing Zed client surface.
  This document stays the route record — read it to learn why a capability is
