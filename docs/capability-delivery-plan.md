...
5. The first live-data connection, show/hide/refresh equivalent, aggregate
   ...
   identifiable — with the direct-server, localhost and `http`-only limits
   recorded. The remaining commands retain their separate interaction/security
   gates.
