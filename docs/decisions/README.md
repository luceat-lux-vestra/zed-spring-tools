...
the supported S011 local PoC. D003 proposes the detailed unmodified-companion
architecture and remains blocked on S012.
...
| [D003](003-java-companion-product-architecture.md) | Java-companion product architecture | Proposed; blocked on S012 |
...
unmodified companion boundary. S012 must validate its bridge before D003 can be
accepted and product scaffolding can begin.
